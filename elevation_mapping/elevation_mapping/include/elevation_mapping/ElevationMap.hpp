...
class ElevationMap {
 ...
 private:
  ...
  void setRobotPoseCache(message_filters::Cache<geometry_msgs::PoseWithCovarianceStamped>* robotPoseCache);
  void setRobotPoseCacheSize(int size);
